    ...
    try {
        ...
        let updateParams = {
            ...
            ExpressionAttributeValues: {
                ':bass': `${params.s3_key}_bass.wav`,
                ':drums': `${params.s3_key}_drums.wav`,
                ':other': `${params.s3_key}_other.wav`,
                ':vocals': `${params.s3_key}_vocals.wav`,
                ':layer2': (params.for_game) ? `${params.s3_key}_2layer.wav` : "",
                ':layer3': (params.for_game) ? `${params.s3_key}_3layer.wav` : "",
